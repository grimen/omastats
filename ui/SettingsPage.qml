...
Column {
  ...
  readonly property var sensorOptions: Model.sensorOptions(snapshot, Model.settingValue(settings, "gpuSource"))
  ...
  Card {
    ...
    Repeater {
      ...
      delegate: Column {
        ...
        // GPU: which card the readout and the GPU page follow, when there are several.
        Dropdown {
